...
public class SampleConstants {
	...
	public static ArrayList<String> windowDomain = new ArrayList<String>(
			Arrays.asList("192.168.2.159", "192.168.2.160", "192.168.2.161", "192.168.2.162", "192.168.2.163",
					"192.168.2.164", "192.168.2.165", "192.168.2.166", "192.168.2.167", "192.168.2.168"));
	public static ArrayList<String> entranceLock = new ArrayList<String>(Arrays.asList("192.168.2.148"));
	public static ArrayList<String> hotWater = new ArrayList<String>(Arrays.asList("192.168.2.149", "192.168.2.150"));
	public static ArrayList<String> awning = new ArrayList<String>(Arrays.asList("192.168.2.169"));
	public static ArrayList<String> tv = new ArrayList<String>(Arrays.asList("192.168.2.134"));
	public static ArrayList<String> radio = new ArrayList<String>(Arrays.asList("192.168.2.136"));

	public static ArrayList<EPC> defaultEPCs = new ArrayList<EPC>(
			Arrays.asList(EPC.x80, EPC.x81, EPC.x82, EPC.x83, EPC.x84, EPC.x85, EPC.x86, EPC.x87, EPC.x88, EPC.x89,
					EPC.x8A, EPC.x8B, EPC.x8C, EPC.x8D, EPC.x8E, EPC.x8F, EPC.x93, EPC.x97, EPC.x98, EPC.x99, EPC.x9A));
